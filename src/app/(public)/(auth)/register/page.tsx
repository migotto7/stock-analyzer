            ...
            <div className="flex flex-col items-center justify-around min-h-screen md:justify-between md:py-6 w-full md:min-h-screen md:w-1/3 bg-gray-300 rounded-xl md:rounded-l-xl shadow-2xs">
                ...
                <div className="flex flex-col items-center gap-6 w-full">
                    ...
                    <form className="flex flex-col gap-5 w-full items-center" onSubmit={handleSubmit}>
                        <input className="w-8/10 md:w-3/4 bg-gray-100 p-4 rounded-2xl outline-gray-500" placeholder="Nome" type="text" id="name" minLength={3} maxLength={255} required />
                        <input className="w-8/10 md:w-3/4 bg-gray-100 p-4 rounded-2xl outline-gray-500" placeholder="Email" type="email" id="email" minLength={3} maxLength={255} required />
                        <input className="w-8/10 md:w-3/4 bg-gray-100 p-4 rounded-2xl outline-gray-500" placeholder="Senha" type="password" id="password" minLength={8} maxLength={30} required />
                        <button className="bg-gray-800 w-8/10 md:w-3/4 p-4 text-white rounded-2xl hover:bg-gray-700 cursor-pointer">Criar conta</button>
                    </form>
                ...
                <div className="flex gap-2 w-8/10 md:w-3/4 items-center justify-center text-sm md:text-base">
                    <p>Já possui conta?</p>
                    <p className="text-sky-900 underline cursor-pointer" onClick={() => router.push("/login")}>Entrar</p>
                </div>
            </div>
        </div>
    )
